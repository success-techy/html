    ...
    <!-- <img src="<?php echo base_url('/assets/web_assets/');?>assets/img/logo.jpg" style="margin-top: -306px;width: 10%;height: auto;"> -->
    <!-- Hero Area Start-->
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xl-9 col-lg-9 col-md-8">
                        ...
                        <?php if(count($jobs)>=15){?>
                         <div class="apply-btn2">
                            <center><button class="btn" data-id="14" data-type="view" onclick="change_status(this)" id="page_limit">View More</button></center>
                         </div>
                        <?php }?>
                        <!-- Featured_job_end -->
                    </div>
              ...
              success: function(res){
                  ...
                  if(obj.length>=1){
                    ...
                    $('#main-list').html(processing(obj));
                     ...
                     $('#main-list').html("");
                    $('#main-list').html('<center><strong> No Jobs Found <a href="'+bases+'" style="color:green;">Find Again</a></strong></center><br><br>');
                }
