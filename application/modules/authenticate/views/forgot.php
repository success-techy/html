          ...
          <div class="row">
            ...
            <div class="col-lg-6 bg-white">
              <div class="form d-flex align-items-center">
                ...
                <?php } ?>
                  <form action="<?=base_url('authenticate/do_reset')?>" method="post" role="form" class="form-validate"> 
                  <?=form_error('email')?>
                  ...
                  </form><!-- <a href="#" class="forgot-pass">Forgot Password?</a> --><br><small>Do not have an account? </small><a href="<?=base_url('authenticate')?>" class="signup">Signup</a>
                </div>
              </div>
            </div>
          </div>
